...
namespace POSManagementProject.Models.ViewModels
{
    public class EmployeeVM
    {
        ...
        [Required]
        [Remote("IsUniqueName", "Employee", ErrorMessage = "The Name already exists", AdditionalFields = "initialName")]
        public string Name { get; set; }
        [Required]
        [StringLength(6, MinimumLength = 6, ErrorMessage = "The Code must be length of 6")]
        [Remote("IsUniqueCode", "Employee", ErrorMessage = "The Code already exists", AdditionalFields = "initialCode")]
